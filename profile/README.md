...
<p align="center">
  <b>Open-source AI tooling — edge inference, private assistants, labeling, training.</b><br/>
  <sub>Offline-first. No cloud lock-in. No mystery telemetry. Runs on consumer hardware.</sub>
</p>

<p align="center">
  <a href="https://nrl.ai"><img alt="Website" src="https://img.shields.io/badge/website-nrl.ai-0a7cff?style=flat-square"></a>
  <a href="https://github.com/nrl-ai"><img alt="GitHub" src="https://img.shields.io/badge/github-nrl--ai-181717?style=flat-square&logo=github"></a>
  <a href="https://vietanh.dev"><img alt="Founder" src="https://img.shields.io/badge/founder-Viet%20Anh%20Nguyen-1f6feb?style=flat-square"></a>
</p>
...
We ship AI tools that run on your laptop, not someone else's GPU cluster. Four areas:

- **🔍 Vision** — annotation tools, edge detection & segmentation kits
- **🤖 Assistants** — on-device multimodal & voice agents for desktops and robots
- **⚙️ Platform** — training pipelines and self-hosted inference
- **📚 Applied** — real-world AI products, including language learning
...
- 💼 Founder — [Viet Anh Nguyen](https://vietanh.dev)
- 🐙 GitHub — [github.com/nrl-ai](https://github.com/nrl-ai)
